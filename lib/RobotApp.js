...
var _tabletrobotfaceUserstudy = require("tabletrobotface-userstudy");
...
function input(_ref) {
  ...
  var faceFeatures$ = PoseDetection.events("poses").map(function (poses) {
    return (0, _tabletrobotfaceUserstudy.extractFaceFeatures)(poses);
  }).startWith(_tabletrobotfaceUserstudy.defaultFaceFeatures);
