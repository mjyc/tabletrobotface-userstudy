...
function input(_ref) {
  ...
  var inputC$ = _xstream2.default.combine(faceFeatures, voiceFeatures, stateStampedHistory$, isVisibleStampedHistory$, vadStateStampedHistory$, speechSynthesisActionResultStamped$).map(function (_ref8) {
    var _ref9 = _slicedToArray(_ref8, 6),
        ...
        speechSynthesisActionResultStamped = _ref9[5];
