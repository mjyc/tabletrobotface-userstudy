...
function input(_ref) {
  ...
  var humanSpeechbubbleActionResultStamped$ = inputD$.filter(function (inputD) {
    ...
    return _extends({ stamp: Date.now() }, inputD);
  }).compose((0, _dropRepeats2.default)(function (x, y) {
  ...
  var inputC$ = _xstream2.default.combine(faceFeatures, voiceFeatures, temporalFeatures, stateStampedHistory$, isVisibleStampedHistory$, vadStateStampedHistory$, humanSpeechbubbleActionResultStamped$, speechSynthesisActionResultStamped$, faceFeatures.filter(function (ff) {
    return !!ff.isVisible;
  }).startWith(_features.defaultFaceFeatures)).map(function (_ref8) {
    var _ref9 = _slicedToArray(_ref8, 9),
        ...
        lastVisibleFaceFeatures = _ref9[8];
    ...
    return {
      ...
      history: {
        ...
        lastVisibleFaceFeatures: lastVisibleFaceFeatures
      },
