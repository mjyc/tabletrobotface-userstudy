...
function input(_ref) {
  ...
  var stateStampedHistory$ = fsmUniqueStateStamped.compose(_pairwise2.default).compose(_pairwise2.default).map(function (_ref2) {
  ...
  var inputC$ = _xstream2.default.combine(faceFeatures, voiceFeatures, stateStampedHistory$, isVisibleStampedHistory$, vadStateStampedHistory$, humanSpeechbubbleActionResultStamped$, speechSynthesisActionResultStamped$).map(function (_ref8) {
    var _ref9 = _slicedToArray(_ref8, 7),
        ...
        humanSpeechbubbleActionResultStamped = _ref9[5],
        speechSynthesisActionResultStamped = _ref9[6];
